...
if [ $rq_kmeans -eq 0 ]; then
    ...
    if [ $cid -eq 0 ]; then
        ...
        if [ $rid -eq 0 ]; then
            ...
            if [ $original -eq 0 ]; then
                ...
                ckpt_path=./checkpoint/decoder/${task_dir}/alpha${alpha}-beta${beta}/
                ...
                ckpt_path=./checkpoint/decoder/${task_dir}/original/
            ...
            ckpt_path=./checkpoint/decoder/${task_dir}/rid/
        ...
        if [ $shuffle -eq 1 ]; then
            ...
            ckpt_path=./checkpoint/decoder/${task_dir}/cid-shuffle-${chunk_size}/
            ...
            ckpt_path=./checkpoint/decoder/${task_dir}/cid-${chunk_size}/
    ...
    if [ $cf_emb -eq 0 ]; then
        ...
        ckpt_path=./checkpoint/decoder/${task_dir}/rq-kmeans/
        ...
        if [ $reduce -eq 0 ]; then
            ...
            ckpt_path=./checkpoint/decoder/${task_dir}/rq-kmeans-cf/
            ...
            ckpt_path=./checkpoint/decoder/${task_dir}/rq-kmeans-cf-reduce/
