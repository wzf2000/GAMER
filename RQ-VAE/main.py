...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--sample_strategy", type=str, default="all", help="sample_strategy"
    )
    parser.add_argument(
        "--cf_emb",
        type=str,
        default="./RQ-VAE/ckpt/Instruments-32d-sasrec.pt",
        help="cf emb",
    )
...
if __name__ == "__main__":
    ...
    cf_emb_tensor: torch.Tensor = torch.load(args.cf_emb)
