...
def get_indices_count(all_indices_str: np.ndarray) -> collections.defaultdict:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--root_path", type=str, default="../checkpoint/", help="root path"
    )
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="epoch_9999_collision_0.0012_model.pth",
...
if __name__ == "__main__":
    ...
    dataset: str = args_setting.dataset
    ckpt_path: str = (
    ...
    def constrained_km(data: np.ndarray, n_clusters: int = 10) -> tuple[torch.Tensor, list[int]]:
