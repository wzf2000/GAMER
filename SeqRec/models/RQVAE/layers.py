...
class MLPLayers(nn.Module):
    def __init__(self, layers: list[int], dropout: float = 0.0, activation: str = "relu", bn: bool = False):
...
def activation_layer(activation_name: str | None | nn.Module = "relu", emb_dim: int | None = None) -> nn.Module | None:
