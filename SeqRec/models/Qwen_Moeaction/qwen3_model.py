...
from SeqRec.models.Qwen_Moeaction.router import QwenMoeactionDecoderRouter
from SeqRec.models.Qwen_Moeaction.FFN import PBATransformersSparseMLP, MyQwen3SparseMLP
...
class MyQwen3MoeModel(Qwen3MoePreTrainedModel):
    ...
    def __init__(self, config: Qwen3MoeConfig):
        ...
        self.router = QwenMoeactionDecoderRouter(config.n_positions, config)
...
class Qwen3WithTemperatureMoeaction(MyQwen3MoeForCausalLM):
    def __init__(self, config):
        super().__init__(config)
