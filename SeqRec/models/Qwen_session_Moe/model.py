...
class Qwen3DecoderLayerSessionMoe(nn.Module):
    def __init__(self, config: Qwen3Config, layer_idx: int, is_sparse: bool, behavior_injection: bool):
        super().__init__()
...
class Qwen3ModelSessionMoe(Qwen3PreTrainedModel):
    """
...
class Qwen3SessionMoeModel(Qwen3ModelSessionMoe):
    def __init__(self, config: Qwen3Config):
...
class Qwen3SessionWithTemperatureMoe(Qwen3ForCausalLM):
    def __init__(self, config: Qwen3Config):
