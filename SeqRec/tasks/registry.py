...
TASK_SPECS: dict[str, str] = {
    ...
    "train_SMB_ranking_decoder": "SeqRec.tasks.training.train_SMB_ranking_decoder:TrainSMBRankingDecoder",
    ...
    "test_SMB_ranking_decoder": "SeqRec.tasks.evaluation.test_SMB_ranking_decoder:TestSMBRankingDecoder",
